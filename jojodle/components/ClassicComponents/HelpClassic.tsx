    ...
    return (
        <div className='flex flex-col gap-4 p-4 bg-[var(--Background)] rounded-lg mt-4 m-auto p-4 g-2 w-210'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-2'>
                    <div className="w-20 h-20 flex justify-center items-center"><Image className='rounded-sm' src={'/images/icon/character/SC/SC_7.png'} alt={'DIO Icon'} width={80} height={80}></Image></div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-2xl text-center leading-4.5 text-[var(--White)]`}>Male</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-xl text-center leading-4.5 text-[var(--White)]`}>195cm (6’5’’)</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Wrong)] rounded-sm flex justify-center items-center text-4xl text-center leading-5.5 text-[var(--White)]`}><Image className='absolute' src={'/images/icon/Arrows/DownArrow.svg'} alt={'Down Arrow'} width={41} height={64}></Image><span className="relative z-10">120</span></div>
                    <div className="w-20 h-20 bg-[var(--Wrong)] rounded-sm flex justify-center items-center"><Image className='rounded' src={'/images/icon/Countries/UnitedKingdom.svg'} alt={'UK Flag'} width={64} height={48}></Image></div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Partial)] rounded-sm flex justify-center items-center text-regular text-center leading-3.5 text-[var(--White)]`}>Joestar Family, Brando Family</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Wrong)] rounded-sm flex justify-center items-center text-regular text-center leading-4.5 text-[var(--White)]`}>Vampire</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-xs text-center leading-2.5 text-[var(--White)]`}>Close-<br></br>Range, Range Irrelevant, Natural Humanoid</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center  text-sm text-center leading-4 text-[var(--White)]`}>Stardust Crusaders</div>
                </div>
                <div className='flex gap-2'>
                    <p className={`${archivoRegular.className} text-[var(--White)] text-xl`}>The correct answer was:</p>
                </div>
                <div className='flex gap-2'>
                    <div className="w-20 h-20 flex justify-center items-center"><Image className='rounded-sm' src={'/images/icon/character/SC/SC_1.png'} alt={'Jotaro Kujo Icon'} width={80} height={80}></Image></div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-2xl text-center leading-4.5 text-[var(--White)]`}>Male</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-xl text-center leading-4.5 text-[var(--White)]`}>195cm (6’5’’)</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-5xl text-center leading-6.5 text-[var(--White)]`}>17</div>
                    <div className="w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center"><Image className='rounded' src={'/images/icon/Countries/Japan.svg'} alt={'Japan Flag'} width={64} height={48}></Image></div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-regular text-center leading-3.5 text-[var(--White)]`}>Joestar Family, Joestar Group</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-regular text-center leading-4.5 text-[var(--White)]`}>Student</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center text-xs text-center leading-2.5 text-[var(--White)]`}>Close-<br></br>Range, Range Irrelevant, Natural Humanoid</div>
                    <div className={`${archivoBold.className} w-20 h-20 bg-[var(--Correct)] rounded-sm flex justify-center items-center  text-sm text-center leading-4 text-[var(--White)]`}>Stardust Crusaders</div>
                </div>
            </div>
