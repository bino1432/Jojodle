...
export default function StarIcon({ correctPath, currentPath, size }: Pathname) {
    return (
        <svg
        viewBox="0 0 48 48"
        fill="currentColor" 
        xmlns="http://www.w3.org/2000/svg"
        className={`${size === "small" ? 'w-6' : size === "medium" ? "w-8" : size === "large" ? 'w-12' : 'w-12'} ${correctPath === currentPath ? "text-[var(--Primary)]" : "text-white"}`}>
